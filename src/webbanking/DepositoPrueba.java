...
public class DepositoPrueba {
     ...
     */
    /*NOTA
    La logica hasta donde implementada funciona, creoq ue deje lo suficientemente moldeable como para que
    se pueda conectar la base de datos de SQL py que de ahi modifique directamente los datos de las cuentas
